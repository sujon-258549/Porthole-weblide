        ...
        <div>
                    ...
                    <nav x-data="{ isOpen: false }" className="relative w-full">
                        <div className="  py-4 mx-auto">
                            <div className="lg:flex lg:items-center lg:justify-between">
                                ...
                                <div className={`absolute inset-x-0 z-20 w-full px-6 py-4 transition-all duration-300 ease-in-out  lg:mt-0 lg:p-0 lg:top-0 lg:relative lg:bg-transparent lg:w-auto lg:opacity-100 lg:translate-x-0 lg:flex lg:items-center ${isOpen ? 'translate-x-0 opacity-100' : 'opacity-0 -translate-x-full'}`}>
            ...
            <section className="container mx-auto my-8 md:my-16">
                ...
                <section id="contact" className="w-[90%] mx-auto">
                    <h1 data-aos="fade-right" data-aos-delay="500" className="text-2xl md:text-4xl md:w-96 mx-auto  lg:text-5xl  font-bold text-center  mt-10 md:mt-16">Contact us</h1>
                                        ...
                                        <form className="mt-6" onSubmit={handleSubmit(onSubmit)}>
                                            <div className="flex-1">
                                                ...
                                                <input
                                                    ...
                                                    className="block w-full px-5 py-3 mt-2  placeholder-gray-400 bg-white border border-gray-200 rounded-md  dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40"
                                                />
                                            ...
                                            <div className="w-full mt-6">
                                                ...
                                                <textarea
                                                    ...
                                                    className="block w-full h-24 px-5 py-3 mt-2  placeholder-gray-400 bg-white border border-gray-200 rounded-md md:h-32  dark:border-gray-700 focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40"
                                                    placeholder="Message"
                                                ></textarea>
