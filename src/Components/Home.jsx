                                ...
                                <div className="container px-6 py-10 mx-auto">
                                    <TabPanel>
                                        <div data-aos="fade-down"
                                            ...
                                            <a href="https://aboul-khair.vercel.app">
                                                <div className="relative overflow-hidden bg-cover object-cover rounded-lg cursor-pointer h-80 group" style={{ backgroundImage: "url('https://aboutorg.com/wp-content/uploads/2023/06/abul-khair-group-brands.jpg", boxShadow: '1px 1px 50px #01ECFF', backgroundPosition:"center", backgroundSize:'contain' }}>
                                                    <div className="flex flex-col justify-center w-full h-full px-8 py-4 transition-opacity duration-700 group-hover:opacity-0 backdrop-blur-sm bg-gray-800/60 opacity-100">
                                                        <FaExternalLinkAlt className="text-4xl text-white text-center mx-auto"></FaExternalLinkAlt>
                                                        <h2 className="mt-4 text-center text-xl font-semibold text-white capitalize">Aboul khair</h2>
                                                        <p className="mt-2 text-center text-lg tracking-wider text-blue-400 uppercase">Visit This Website</p>
